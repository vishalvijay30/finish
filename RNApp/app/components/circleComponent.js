...
export default class CircleComponent extends Component{
    render() {
            ...
            return(<View style={{margin:20, alignItems:"center", justifyContent:"center", height:147, width:147, borderRadius:100, borderWidth:3, borderColor:this.decideBorderColor(), backgroundColor:"#008080"}}>
